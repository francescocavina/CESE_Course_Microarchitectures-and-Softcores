...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net buttons_GPIO [get_bd_intf_ports GPIO_1] [get_bd_intf_pins buttons/GPIO]
  ...
  connect_bd_intf_net -intf_net switches_GPIO [get_bd_intf_ports GPIO_0] [get_bd_intf_pins switches/GPIO]

  # Create port connections
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins vio/clk]
  connect_bd_net -net led_pin_LED [get_bd_pins led_pin/LED] [get_bd_pins vio/probe_in0]
  ...
  connect_bd_net -net vio_probe_out0 [get_bd_pins switches/gpio_io_i] [get_bd_pins vio/probe_out0]
  connect_bd_net -net vio_probe_out1 [get_bd_pins buttons/gpio_io_i] [get_bd_pins vio/probe_out1]
