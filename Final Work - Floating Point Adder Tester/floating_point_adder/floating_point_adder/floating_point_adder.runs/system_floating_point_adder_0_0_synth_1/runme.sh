...
HD_PWD='/home/francesco/Desktop/tp/floating_point_adder/floating_point_adder/floating_point_adder.runs/system_floating_point_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_floating_point_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_floating_point_adder_0_0.tcl
